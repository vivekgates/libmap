 ...
 */
package org.unyde.mapintegrationlib.util.viewpagerAdsCard;
...
public class AnchorBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final float EXPAND_FRICTION = 0.5f;

    private static final float COLLAPSE_FRICTION = 0.5f;
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mPeekHeightAuto) {
            ...
            peekHeight = Math.max(mPeekHeightMin, mParentHeight - parent.getWidth() * 7 / 13);
        } else {
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        mVelocityTracker.computeCurrentVelocity(3000, mMaximumVelocity);
