package org.unyde.mapintegrationlib.InternalNavigation.collision;

import android.opengl.GLU;
import android.util.Log;
import org.unyde.mapintegrationlib.InternalNavigation.math.Math3DUtils;
import org.unyde.mapintegrationlib.InternalNavigation.model.BoundingBox;
...
public class CollisionDetection {
    ...
    private static Object3DData getBoxIntersection(List<Object3DData> objects, float[] p1, float[] direction) {
        ...
        {
         Log.e("Collosion Detect",e.getMessage())   ;
        }
