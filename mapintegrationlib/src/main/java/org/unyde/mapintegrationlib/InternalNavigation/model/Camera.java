package org.unyde.mapintegrationlib.InternalNavigation.model;
...
public class Camera {
	...
	public float currentRotationAngle; // Keeps us from going too far up or down.
	...
	public Camera() {
		...
		//this(0, 5, -3, 0, 0, 0, 0, 0, 1);
		this(0, 5, 0, 0, 0, 1, 0, 1, 0);
	}
	...
	public void MoveCameraZImpl(float direction) {
		...
		//UpdateCamera(xLookDirection, zLookDirection, yLookDirection, direction);
	}
	...
	public void set_camera(float xPos, float yPos, float zPos, float xView, float yView, float zView, float xUp, float yUp,
						   float zUp)
	{
		this.xPos = xPos;
		this.yPos = yPos;
