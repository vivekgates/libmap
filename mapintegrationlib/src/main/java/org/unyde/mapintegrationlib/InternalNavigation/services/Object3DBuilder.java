package org.unyde.mapintegrationlib.InternalNavigation.services;
...
import org.unyde.mapintegrationlib.InternalNavigation.services.collada.entities.Joint;
...
public final class Object3DBuilder {
	...
	public static Object3DData buildcustomPlane(float[] custom_cubePositionData) {
		return new Object3DData(
				createNativeByteBuffer(custom_cubePositionData.length * 4).asFloatBuffer().put(custom_cubePositionData))
				.setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV1").setFaces(new WavefrontLoader.Faces(1));
	}
	...
	final static float[] planePositionData = {
			//@formatter:off
			// Front face
	...
	final static float[] planePositionData2 = {
			//@formatter:off
			// Front face
	...
	final static float[] planePositionDatapopup = {
			//@formatter:off
			// Front face
	...
	final static float[] planePositionData3 = {
			//@formatter:off
			// Front face
	...
	final static float[] planePositionData4 = {
			//@formatter:off
			// Front face
...
*/
	...
	final static float[] planeTextureCoordinateData =
			{
	...
	final static float[] planeNormalData =
			{
	...
	final static float[] planeColorData = {
	...
	public static Object3DData buildSquareline(float[] squareLineData ) {
		IntBuffer drawBuffer = createNativeByteBuffer(squareDrawOrderData.length * 4).asIntBuffer().put(squareDrawOrderData);
		FloatBuffer vertexBuffer = createNativeByteBuffer(squareLineData.length * 4).asFloatBuffer().put(squareLineData);
		return new Object3DData(vertexBuffer,drawBuffer.asReadOnlyBuffer()).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV2").setFaces(new WavefrontLoader.Faces(8)).setDrawOrder(drawBuffer).setVertexArrayBuffer(vertexBuffer);
	}
	...
	public static Object3DData buildplaneV4(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionData.length * 4).asFloatBuffer().put(planePositionData),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(planeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV4").setFaces(new WavefrontLoader.Faces(1));
	}

	public static Object3DData buildplane2V4(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionData2.length * 4).asFloatBuffer().put(planePositionData2),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(planeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV4").setFaces(new WavefrontLoader.Faces(1));
	...
	public static Object3DData buildplanemall2V4(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionData3.length * 4).asFloatBuffer().put(planePositionData3),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(planeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV4").setFaces(new WavefrontLoader.Faces(1));
	...
	public static Object3DData buildplanemall2V5(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionData4.length * 4).asFloatBuffer().put(planePositionData4),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(planeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV4").setFaces(new WavefrontLoader.Faces(1));
	...
	public static Object3DData buildplanepopupV4(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionDatapopup.length * 4).asFloatBuffer().put(planePositionDatapopup),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(planeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV4").setFaces(new WavefrontLoader.Faces(1));
	...
	public static Object3DData buildplane3V4(byte[] textureData) {
		return new Object3DData(
				createNativeByteBuffer(planePositionData3.length * 4).asFloatBuffer().put(planePositionData3),
				createNativeByteBuffer(planeColorData.length * 4).asFloatBuffer().put(planeColorData).asReadOnlyBuffer(),
				createNativeByteBuffer(planeTextureCoordinateData.length * 4).asFloatBuffer()
	...
	public static Object3DData loadV5(Activity activity, Uri modelUri) {
		try {
			...
			//InputStream is = activity.getAssets().open(modelUri.toString());
			InputStream is = new FileInputStream(new File(modelUri.toString()));
			...
			is = new FileInputStream(new File(modelUri.toString()));
			wfl.loadModel(is);
			is.close();
	...
	public static Object3DData loadV5_bg(Activity activity, Uri modelUri) {
		try {
			//final String modelId = assetDir + "/" + assetFilename;
			...
			is = activity.getAssets().open(modelUri.toString());
			wfl.loadModel(is);
			is.close();
