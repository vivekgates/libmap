...
public final class TestData {
    ...
    public static List<PointF> getMarks() {
        ...
        marks.add(new PointF(89, 527));
        marks.add(new PointF(411, 460));
        marks.add(new PointF(509, 250));
        marks.add(new PointF(825, 250));
        marks.add(new PointF(991, 250));
        marks.add(new PointF(991, 609));
        marks.add(new PointF(1350, 250));
        marks.add(new PointF(1350, 609));
        marks.add(new PointF(1583, 440));
    ...
    public static List<String> getMarksName() {
        ...
        marksName.add("Entrance");
        marksName.add("Entrance2");
        marksName.add("Entrance3");
        marksName.add("Cabin1");
        marksName.add("Cabin2");
        marksName.add("Priyanka Madam");
        marksName.add("comfort zone");
        marksName.add("Abhinav Sir");
        marksName.add("Cafeteria");

        return marksName;
    }

    public static List<String> getNodeName() {
        List<String> nodeName = new ArrayList<>();

        nodeName.add("a7000000000000000000000000000000");
        nodeName.add("a8000000000000000000000000000000");
        nodeName.add("a9000000000000000000000000000000");
        nodeName.add("aa000000000000000000000000000000");
        nodeName.add("ab000000000000000000000000000000");
        nodeName.add("a2000000000000000000000000000000");
        nodeName.add("a3000000000000000000000000000000");
        nodeName.add("a4100101000128010000101000010100");
        nodeName.add("a5100102000128010000101000010100");
