package org.unyde.mapintegrationlib.InternalNavigation.services.wavefront;
...
public class WavefrontLoaderTask extends LoaderTask {
    ...
    public WavefrontLoaderTask(final AppCompatActivity parent, final Uri uri, final Callback callback) {
