package org.unyde.mapintegrationlib.bottomnavigation.utils;
...
import org.unyde.mapintegrationlib.bottomnavigation.BottomNavigation;
...
public class AnimationHelper {
    ...
    public static int ANIMATION_DURATION = 5;
    ...
    public void animateDeactivate(final TextView tabText, final ImageView tabIcon) {
        switch (type) {
            case BottomNavigation.TYPE_FIXED:
                AlphaAnimation fAlphaAnimation = new AlphaAnimation(0.5f, 0.5f);
                ...
                ScaleAnimation fScaleAnimation = new ScaleAnimation(1, 1, 1, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);

                AnimationSet fAnimationSet = new AnimationSet(true);
                fAnimationSet.setDuration(5);
            ...
            case BottomNavigation.TYPE_DYNAMIC:
                AlphaAnimation dAlphaAnimation = new AlphaAnimation(0.5f, 0.5f);
                ...
                ScaleAnimation dScaleAnimation = new ScaleAnimation(0, 0, 0, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
                dScaleAnimation.setDuration(5);
    ...
    public void animateActivate(final TextView tabText, final ImageView tabIcon) {
        switch (type) {
            case BottomNavigation.TYPE_FIXED:
                ...
                ScaleAnimation fTextScaleAnimation = new ScaleAnimation(1, 1, 1, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
                AnimationSet fAnimationSet = new AnimationSet(true);
            ...
            case BottomNavigation.TYPE_DYNAMIC:
                ...
                ScaleAnimation dTextScaleAnimation = new ScaleAnimation(0, 0, 0, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    ...
    public void animateActivate(final TextView tabText, final ImageView tabIcon,
        ...
        switch (type) {
            ...
            case BottomNavigation.TYPE_DYNAMIC:
                ...
                ScaleAnimation dTextScaleAnimation = new ScaleAnimation(1, 1, 1, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
                dTextScaleAnimation.setDuration(ANIMATION_DURATION);
                dTextScaleAnimation.setFillAfter(true);
                tabText.startAnimation(dTextScaleAnimation);
                dPaddingAnimator.start();
    ...
    public void animateDeactivate(final TextView tabText, final ImageView tabIcon,
        ...
        switch (type) {
            ...
            case BottomNavigation.TYPE_DYNAMIC:
                ...
                ScaleAnimation dScaleAnimation = new ScaleAnimation(1, 1, 1, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
                dScaleAnimation.setDuration(5);
                dScaleAnimation.setFillAfter(true);
                tabText.startAnimation(dScaleAnimation);
                dPaddingAnimator.start();
