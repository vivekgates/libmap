package org.unyde.mapintegrationlib.bottomnavigation;
...
import org.unyde.mapintegrationlib.bottomnavigation.events.OnTabItemClickListener;
import org.unyde.mapintegrationlib.bottomnavigation.utils.AnimationHelper;
import org.unyde.mapintegrationlib.bottomnavigation.utils.LayoutParamsHelper;
import org.unyde.mapintegrationlib.bottomnavigation.utils.Util;
...
public class TabItem extends FrameLayout implements View.OnClickListener {
    ...
    private void setupView() {
        ...
        if (bottomNavigation.getMode() == BottomNavigation.MODE_PHONE) {
            ...
            setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dpToPx(47)));
        }
        ...
        Typeface myCustomFont = Typeface.createFromAsset(getContext().getAssets(),"montserrat_regular.ttf");
        ...
        iconImageView.setBackgroundColor(getContext().getResources().getColor(R.color.white));
