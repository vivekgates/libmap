...
public class NearBeacon {
    ...
    public long storeFirstSeentimestamp = System.currentTimeMillis();
    ...
    public NearBeacon(byte[] uidServiceData, ScanResult result) {
        this.result = result;
        this.uidServiceData = uidServiceData;
    }
    public NearBeacon(String deviceAddress, int rssi) {
    ...
    public NearBeacon(String uid, long lastSeenTimestamp, long firstSeenTImeStamp, Boolean isFirstTimeCaptured, String nodeId) {
        this.uid=uid;
